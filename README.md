...
You can checkout the initial documentation of the library by hitting the link [Laravel Model PHPDoc Generator Github](https://github.com/romanzipp/Laravel-Model-Doc)
